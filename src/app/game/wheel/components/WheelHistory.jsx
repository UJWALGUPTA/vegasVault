...
const WheelHistory = ({ gameHistory = [] }) => {
  ...
  const [page, setPage] = useState(1);
   ...
   // Open Somnia Explorer link for transaction hash
   const openSomniaExplorer = (hash) => {
                          ...
                          <Button
                            onClick={() => {
                              if (item.entropyProof.transactionHash) {
                                window.open(`https://entropy-explorer.pyth.network/?chain=somnia-testnet&search=${item.entropyProof.transactionHash}`, '_blank');
                              }
                            }}
                            size="small"
