...
const NewsUpdates = () => {
  const newsItems = [
    {
      id: 1,
      title: 'New Token Bridge Partnership with Somnia Network',
      excerpt: 'VegasVault partners with Somnia Network to provide seamless cross-chain token transfers with lower fees.',
      date: '2025-05-08',
    ...
    {
      id: 2,
      title: 'SOMI/STT Governance Proposal: Community Jackpots',
    ...
    },
    {
      ...
      excerpt: 'VegasVault\'s smart contracts have passed rigorous security auditing by Certik with high scores.',
      date: '2025-05-02',
      category: 'Security',
